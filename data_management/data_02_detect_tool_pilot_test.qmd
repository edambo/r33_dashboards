...
Some values have empty values due to skip logic and not because they are actually missing. These values will be replaced by "Not applicable due to skip logic"
...
save(missing_plot_data, text_box_plot_data, text_box_table_data, 
